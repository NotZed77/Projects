package resources.P2Calculator;
import javax.swing.*;
import java.awt.*;
...
public class Calculator implements ActionListener{
    ...
    Calculator() {
        ...
        clrButton.setBounds(275,430,150,50);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if (e.getSource() == negButton) {
            ...
            if (!text.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null, "Please enter a number first!", "Input Required", JOptionPane.WARNING_MESSAGE);
            }
        }
    }
}
